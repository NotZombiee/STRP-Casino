...
Config.WheelPos = {x = 949.66, y = 45.00, z = 70.89, h = 327.99}	-- Where the wheel prop will spawn OR where wheel prop is
Config.VehiclePos = {x = 934.79, y = 42.49, z = 72.10, h = 0}
