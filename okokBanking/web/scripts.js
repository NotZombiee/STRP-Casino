	...
	switch (event.data.action) {
			...
			if (selectedWindow == "none") {
				...
				$('#menu').html(`
					<div class="d-flex justify-content-center flex-column align-items-center">
						...
						<br>
						<div style="font-size: 40px; color: #fff;">Inserting Card...</div>
					</div>
				`);
				$("#menu").fadeIn();
				$(".main_card").fadeIn();
		...
		case 'transactions_page':
			...
			if (event.data.isInSociety){
				society = `<span class="sidebar-title mt-5">Business</span>
			...
			for(var i = 0; i < num; i++) {
				...
				if (db.type == 'transfer' && db.receiver_identifier == event.data.identifier) {
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								From <span style="color: #268f3a; font-weight: 600;">${db.sender_name}</span>
				...
				// Sent
					...
					data = `<td class="align-middle" style="font-weight: 500;">
								To <span style="color: #268f3a; font-weight: 600;">${db.receiver_name}</span>
				...
				// Deposited
					...
					icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								Into <span style="color: #268f3a; font-weight: 600;">${db.receiver_name}</span>
				...
				// Withdrawn
					...
					icon = '<td class="align-middle"><span style="background-color: #1d1e24; padding: 10px 15px 10px 15px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>';
					data = `<td class="align-middle" style="font-weight: 500;">
								From <span style="color: #FF0000; font-weight: 600;">${db.sender_name}</span>
								<div style="margin-top: -5px;">Withdrawn</div>
							</td>`;
					amount = `<td class="align-middle" style="font-weight: 500;"><span style="float: right; color: #FF0000;"> - $${db.value.toLocaleString()}</span> </td>`;
				}
			...
			$('#page_info').html(`
				<div class="row mb-3">
					<div class="col col-md-3">
						<div class="card" style="background-color: #268f3a; border-radius: 10px; color: #fff;">
					...
					<tbody id="transactionsData">
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								To <span style="color: #268f3a;">Arthur James</span>
								<div style="margin-top: -5px;">Sent</div>
							</td>
						...
						<tr>
							...
							<td class="align-middle" style="font-weight: 500; font-size: 16px;">
								Into <span style="color: #268f3a;">Bank Account</span>
								<div style="margin-top: -5px;">Deposited</div>
							</td>
							<td class="align-middle" style="font-weight: 500;">28 Aug 04:43</td>
...
function overview_page_function(event) {
							...
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-upload"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #268f3a;">Arthur James</span>
											<div style="margin-top: -5px;">Received</div>
										</td>
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #268f3a;">Bank Account</span>
											<div style="margin-top: -5px;">Withdrawn</div>
										</td>
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">Fleeca Debit</span></span><span><i class="fas fa-wifi"></i></span></span>
								<div style="margin-top: 38%;">
									<div class="d-flex align-items-center">
										<span style="font-weight: 500; color: #fff; line-height: 1;">Status</span>
									</div>
									<div class="d-flex justify-content-between align-items-center">
										<span style="color: #fff; font-size: 18px; color: #fff; line-height: 1; text-shadow: 0px 0px 2px rgba(255, 255, 255, 0.5);">ACTIVE</span>
						...
						<hr>
						<p class="card-text text-center" style="font-size: 20px;"><span style="color: #fff;">Balance: $</span><span id="playerBankMoney"></span></p>
	...
	gradient.addColorStop(0, 'rgba(38, 143, 58, 0.5)');
	gradient.addColorStop(1, 'rgba(26, 99, 40, 0)');
...
function society_page_function(event) {
	...
	$('#page-title').html('Business ['+event.data.societyInfo.society_name+']');
							...
							<table id="lastTransactionsTable">
								<tbody id="lastTransactionsData">
									...
									<tr>
										<td class="align-middle"><span style="background-color: #1d1e24; padding: 5px 10px 5px 10px; border-radius: 10px;"><i class="bi bi-download"></i></span></td>
										<td class="align-middle" style="font-weight: 500; font-size: 16px;">
											From <span style="color: #FF0000;">Bank Account</span>
											<div style="margin-top: -5px;">Withdrawn</div>
										</td>
										<td class="align-middle" style="font-weight: 500;"><span>- 7 000 EUR</span> </td>
									</tr>
			...
			<div class="col-md-12">
				<div class="card" style="background-color: transparent; border-radius: 10px; box-shadow: 0px 0px 5 0px rgba(0, 0, 0, 0.75);">
					...
					<div class="card-body" style="background-color: #1d1e24; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; font-size: 16px;">
						<div class="card creditcard-classic_card d-flex align-items-center" style="margin: 0 auto; margin-bottom: 16px;">
							<div class="card-body creditcard-classic_card-body">
								<span class="d-flex justify-content-between"><span><img src="visa_white.svg" style="width: 20%;"><span style="color: #fff; font-size: 12px; margin-left: 5px; font-weight: 500;">Fleeca Business</span></span><span><i class="fas fa-wifi"></i></span></span>
								<div style="margin-top: 38%;">
									<div class="d-flex align-items-center">
										<span style="font-weight: 500; color: #fff; line-height: 1;">Status</span>
									</div>
					...
					<div class="">
						<div class="row">
							...
							<div class="col col-md-6 d-flex align-items-center">
								<div class="card w-100 h-100 d-flex justify-content-center" style="background-color: #268f3a; border-radius: 10px; color: #fff;">
